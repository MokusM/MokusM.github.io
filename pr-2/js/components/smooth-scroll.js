...
var SmoothScroll = /** @class */ (function () {
    function SmoothScroll(options) {
        ...
        this._update = function (currentTime) {
            ...
            if (resized) {
                ...
                setTimeout(function(){
                    ...
                    document.getElementById('viewport-scroll').style.height = height + "px";
            ...
            for (var i = 0; i < _this.scrollItems.length; i++) {
                ...
                item.target.style.transform = "translate3d(0px,-" + item.currentOffset + 100 + "px,0px)";
            }
        ...
        this._update();
//        $(".section-arrow__down-js").click(function(){
//            _this.target.style.transform = "translate3d(0px,-" + _this.currentScroll + 300 + "px,0px)";
//           console.log('ddd')
//            item.target.style.transform = "translate3d(0px,-" + item.currentOffset + 300 + "px,0px)";
//            return false
//        })
    }
